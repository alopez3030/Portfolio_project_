        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              ...
              From reading up on the latest technological advancements,
              playing sports, creating music, to creating cloned applications to
              understand the concepts that were taken to create these successful apps
              in order to hone in on what makes an application successful.I enjoy seeking new
              experiences and love to keep myself engaged.
            </p>
            <br />
            <p>
